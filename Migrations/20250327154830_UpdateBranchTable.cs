    ...
    public partial class UpdateBranchTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Branch__3214EC073FF21966", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Employee__3214EC07F70E77B3", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Membersh__3214EC077E9FB408", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverAccount = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PaymentM__3214EC07DBD5B7BA", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductC__3214EC0716D900AF", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TableSta__3214EC0721310431", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Employee__3214EC07CB7FCFAC", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    MembershipLevelId = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__3214EC071D628847", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customer_MembershipLevel",
                        column: x => x.MembershipLevelId,
                        principalTable: "MembershipLevel",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Product__3214EC071741E437", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Billiard__3214EC077260D2FA", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BilliardTable_Branch",
                        column: x => x.BranchId,
                        principalTable: "Branch",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BilliardTable_TableStatus",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Invoice__3214EC07B26A444E", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reservat__3214EC07C17AA4F1", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservation_BilliardTable",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPlayPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    UpdatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__InvoiceD__3214EC077A680323", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ServiceP__3214EC07D1DA5B90", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceProductDetail_Invoice",
                        column: x => x.InvoiceId,
                        principalTable: "Invoice",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceProductDetail_Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BilliardTable_StatusId",
                table: "BilliardTable",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "UQ_BilliardTable_Branch_TableNumber",
                table: "BilliardTable",
                columns: new[] { "BranchId", "TableNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Branch__737584F6C395A1B3",
                table: "Branch",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Customer_MembershipLevelId",
                table: "Customer",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Employee__A9D10534DA591CE0",
                table: "Employee",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Employee__737584F61649B571",
                table: "EmployeeRole",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Membersh__737584F6F8086941",
                table: "MembershipLevel",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__PaymentM__D85E702652C33011",
                table: "PaymentMethod",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ProductC__8517B2E0AF26B6EE",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProductDetail_InvoiceId",
                table: "ServiceProductDetail",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProductDetail_ProductId",
                table: "ServiceProductDetail",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "UQ__TableSta__737584F6F614FD17",
                table: "TableStatus",
                column: "Name",
                unique: true);
        }
